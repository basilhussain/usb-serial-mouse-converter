...
#define HSI_VALUE              ((uint32_t)48000000) /* Frequency, in Hz, of the High-Speed Internal RC oscillator */
...
/* Electronic Signature Registers */
typedef struct
{
	__I uint16_t FLACAP;
	uint16_t     RESERVED0;
...
#define VENDOR                                  ((VENDOR_TypeDef *)VENDOR_BASE)
...
#define STK_STCLK                               ((uint32_t)0x00000004) /* Counter clock source selection */
#define STK_STRE                                ((uint32_t)0x00000008) /* Auto-reload Count enable */
#define STK_MODE                                ((uint32_t)0x00000010) /* Counting mode */
#define STK_INIT                                ((uint32_t)0x00000020) /* Counter initial value update */
#define STK_SWIE                                ((uint32_t)0x80000000) /* Software interrupt trigger enable (SWI) */
...
/******************************************************************************/
/*            Programmable Fast Interrupt Controller (PFIC / NVIC)            */
/******************************************************************************/

/********************  Bit definition for PFIC_CFGR register  ******************/
#define PFIC_KEYCODE                            ((uint32_t)0xFFFF0000) /* Security access key code */
#define PFIC_KEY1                               ((uint32_t)0xFA050000)
#define	PFIC_KEY2                               ((uint32_t)0xBCAF0000)
#define	PFIC_KEY3                               ((uint32_t)0xBEEF0000)
#define PFIC_SYSRESET                           ((uint32_t)0x00000080) /* System reset */

/********************  Bit definition for PFIC_GISR register  ******************/
#define PFIC_NESTSTA                            ((uint32_t)0x000000FF) /* Interrupt nesting status */
#define PFIC_NESTSTA_LVL1                       ((uint32_t)0x00000001) /* Level 1 interrupt in progress */
#define PFIC_NESTSTA_LVL2                       ((uint32_t)0x00000003) /* Level 2 interrupt in progress */
#define PFIC_NESTSTA_LVL3                       ((uint32_t)0x00000007) /* Level 3 interrupt in progress */
#define PFIC_NESTSTA_LVL4                       ((uint32_t)0x0000000F) /* Level 4 interrupt in progress */
#define PFIC_NESTSTA_LVL5                       ((uint32_t)0x0000001F) /* Level 5 interrupt in progress */
#define PFIC_NESTSTA_LVL6                       ((uint32_t)0x0000003F) /* Level 6 interrupt in progress */
#define PFIC_NESTSTA_LVL7                       ((uint32_t)0x0000007F) /* Level 7 interrupt in progress */
#define PFIC_NESTSTA_LVL8                       ((uint32_t)0x000000FF) /* Level 8 interrupt in progress */
#define PFIC_GACTSTA                            ((uint32_t)0x00000100) /* Interrupts currently active */
#define PFIC_GPENDSTA                           ((uint32_t)0x00000200) /* Interrupts currently pending */

/********************  Bit definition for PFIC_VTFADDR register  ******************/
#define PFIC_VTFADDR_ADDR                       ((uint32_t)0xFFFFFFFE) /* ISR address */
#define PFIC_VTFADDR_EN                         ((uint32_t)0x00000001) /* Enable bit */

/********************  Bit definition for PFIC_SCTLR register  ******************/
#define PFIC_SCTLR_SLEEPONEXIT                  ((uint32_t)0x00000002) /* Enter low-power mode on exiting ISR */
#define PFIC_SCTLR_SLEEPDEEP                    ((uint32_t)0x00000004) /* Low-power mode deep sleep */
#define PFIC_SCTLR_WFITOWFE                     ((uint32_t)0x00000008) /* Execute WFI as if WFE */
#define PFIC_SCTLR_SEVONPEND                    ((uint32_t)0x00000010) /* Enabled events and all interrupts can wake system */
#define PFIC_SCTLR_SETEVENT                     ((uint32_t)0x00000020) /* Set the event to wake up the WFE case */
...
/*
NOTES:
- CH32X035 does not appear to have configurable drive strength on GPIO outputs,
  so all *_OUTPUT_xM values are effectively the same.
- CH32X035 does not have open-drain capability on any GPIO outputs, so there are
  no *_OPEN_DRAIN values.
*/
...
#define GPIO_CFGLR_MODE0_INPUT                  ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGLR_MODE0_OUTPUT_10M             ((uint32_t)0x00000001) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGLR_MODE0_OUTPUT_2M              ((uint32_t)0x00000002) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGLR_MODE0_OUTPUT_50M             ((uint32_t)0x00000003) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGLR_MODE1_INPUT                  ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGLR_MODE1_OUTPUT_10M             ((uint32_t)0x00000010) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGLR_MODE1_OUTPUT_2M              ((uint32_t)0x00000020) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGLR_MODE1_OUTPUT_50M             ((uint32_t)0x00000030) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGLR_MODE2_INPUT                  ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGLR_MODE2_OUTPUT_10M             ((uint32_t)0x00000100) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGLR_MODE2_OUTPUT_2M              ((uint32_t)0x00000200) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGLR_MODE2_OUTPUT_50M             ((uint32_t)0x00000300) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGLR_MODE3_INPUT                  ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGLR_MODE3_OUTPUT_10M             ((uint32_t)0x00001000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGLR_MODE3_OUTPUT_2M              ((uint32_t)0x00002000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGLR_MODE3_OUTPUT_50M             ((uint32_t)0x00003000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGLR_MODE4_INPUT                  ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGLR_MODE4_OUTPUT_10M             ((uint32_t)0x00010000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGLR_MODE4_OUTPUT_2M              ((uint32_t)0x00020000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGLR_MODE4_OUTPUT_50M             ((uint32_t)0x00030000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGLR_MODE5_INPUT                  ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGLR_MODE5_OUTPUT_10M             ((uint32_t)0x00100000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGLR_MODE5_OUTPUT_2M              ((uint32_t)0x00200000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGLR_MODE5_OUTPUT_50M             ((uint32_t)0x00300000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGLR_MODE6_INPUT                  ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGLR_MODE6_OUTPUT_10M             ((uint32_t)0x01000000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGLR_MODE6_OUTPUT_2M              ((uint32_t)0x02000000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGLR_MODE6_OUTPUT_50M             ((uint32_t)0x03000000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGLR_MODE7_INPUT                  ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGLR_MODE7_OUTPUT_10M             ((uint32_t)0x10000000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGLR_MODE7_OUTPUT_2M              ((uint32_t)0x20000000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGLR_MODE7_OUTPUT_50M             ((uint32_t)0x30000000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGLR_CNF0_INPUT_ANALOG            ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGLR_CNF0_INPUT_FLOAT             ((uint32_t)0x00000004) /* Floating Input */
#define GPIO_CFGLR_CNF0_INPUT_PULL              ((uint32_t)0x00000008) /* Input With Pull-Up/Down */
#define GPIO_CFGLR_CNF0_OUTPUT_PUSH_PULL        ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGLR_CNF0_OUTPUT_MUX_PUSH_PULL    ((uint32_t)0x00000008) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGLR_CNF1_INPUT_ANALOG            ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGLR_CNF1_INPUT_FLOAT             ((uint32_t)0x00000040) /* Floating Input */
#define GPIO_CFGLR_CNF1_INPUT_PULL              ((uint32_t)0x00000080) /* Input With Pull-Up/Down */
#define GPIO_CFGLR_CNF1_OUTPUT_PUSH_PULL        ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGLR_CNF1_OUTPUT_MUX_PUSH_PULL    ((uint32_t)0x00000080) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGLR_CNF2_INPUT_ANALOG            ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGLR_CNF2_INPUT_FLOAT             ((uint32_t)0x00000400) /* Floating Input */
#define GPIO_CFGLR_CNF2_INPUT_PULL              ((uint32_t)0x00000800) /* Input With Pull-Up/Down */
#define GPIO_CFGLR_CNF2_OUTPUT_PUSH_PULL        ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGLR_CNF2_OUTPUT_MUX_PUSH_PULL    ((uint32_t)0x00000800) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGLR_CNF3_INPUT_ANALOG            ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGLR_CNF3_INPUT_FLOAT             ((uint32_t)0x00004000) /* Floating Input */
#define GPIO_CFGLR_CNF3_INPUT_PULL              ((uint32_t)0x00008000) /* Input With Pull-Up/Down */
#define GPIO_CFGLR_CNF3_OUTPUT_PUSH_PULL        ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGLR_CNF3_OUTPUT_MUX_PUSH_PULL    ((uint32_t)0x00008000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGLR_CNF4_INPUT_ANALOG            ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGLR_CNF4_INPUT_FLOAT             ((uint32_t)0x00040000) /* Floating Input */
#define GPIO_CFGLR_CNF4_INPUT_PULL              ((uint32_t)0x00080000) /* Input With Pull-Up/Down */
#define GPIO_CFGLR_CNF4_OUTPUT_PUSH_PULL        ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGLR_CNF4_OUTPUT_MUX_PUSH_PULL    ((uint32_t)0x00080000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGLR_CNF5_INPUT_ANALOG            ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGLR_CNF5_INPUT_FLOAT             ((uint32_t)0x00400000) /* Floating Input */
#define GPIO_CFGLR_CNF5_INPUT_PULL              ((uint32_t)0x00800000) /* Input With Pull-Up/Down */
#define GPIO_CFGLR_CNF5_OUTPUT_PUSH_PULL        ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGLR_CNF5_OUTPUT_MUX_PUSH_PULL    ((uint32_t)0x00800000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGLR_CNF6_INPUT_ANALOG            ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGLR_CNF6_INPUT_FLOAT             ((uint32_t)0x04000000) /* Floating Input */
#define GPIO_CFGLR_CNF6_INPUT_PULL              ((uint32_t)0x08000000) /* Input With Pull-Up/Down */
#define GPIO_CFGLR_CNF6_OUTPUT_PUSH_PULL        ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGLR_CNF6_OUTPUT_MUX_PUSH_PULL    ((uint32_t)0x08000000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGLR_CNF7_INPUT_ANALOG            ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGLR_CNF7_INPUT_FLOAT             ((uint32_t)0x40000000) /* Floating Input */
#define GPIO_CFGLR_CNF7_INPUT_PULL              ((uint32_t)0x80000000) /* Input With Pull-Up/Down */
#define GPIO_CFGLR_CNF7_OUTPUT_PUSH_PULL        ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGLR_CNF7_OUTPUT_MUX_PUSH_PULL    ((uint32_t)0x80000000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGHR_MODE8_INPUT                  ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGHR_MODE8_OUTPUT_10M             ((uint32_t)0x00000001) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGHR_MODE8_OUTPUT_2M              ((uint32_t)0x00000002) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGHR_MODE8_OUTPUT_50M             ((uint32_t)0x00000003) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGHR_MODE9_INPUT                  ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGHR_MODE9_OUTPUT_10M             ((uint32_t)0x00000010) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGHR_MODE9_OUTPUT_2M              ((uint32_t)0x00000020) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGHR_MODE9_OUTPUT_50M             ((uint32_t)0x00000030) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGHR_MODE10_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGHR_MODE10_OUTPUT_10M            ((uint32_t)0x00000100) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGHR_MODE10_OUTPUT_2M             ((uint32_t)0x00000200) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGHR_MODE10_OUTPUT_50M            ((uint32_t)0x00000300) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGHR_MODE11_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGHR_MODE11_OUTPUT_10M            ((uint32_t)0x00001000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGHR_MODE11_OUTPUT_2M             ((uint32_t)0x00002000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGHR_MODE11_OUTPUT_50M            ((uint32_t)0x00003000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGHR_MODE12_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGHR_MODE12_OUTPUT_10M            ((uint32_t)0x00010000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGHR_MODE12_OUTPUT_2M             ((uint32_t)0x00020000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGHR_MODE12_OUTPUT_50M            ((uint32_t)0x00030000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGHR_MODE13_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGHR_MODE13_OUTPUT_10M            ((uint32_t)0x00100000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGHR_MODE13_OUTPUT_2M             ((uint32_t)0x00200000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGHR_MODE13_OUTPUT_50M            ((uint32_t)0x00300000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGHR_MODE14_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGHR_MODE14_OUTPUT_10M            ((uint32_t)0x01000000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGHR_MODE14_OUTPUT_2M             ((uint32_t)0x02000000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGHR_MODE14_OUTPUT_50M            ((uint32_t)0x03000000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGHR_MODE15_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGHR_MODE15_OUTPUT_10M            ((uint32_t)0x10000000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGHR_MODE15_OUTPUT_2M             ((uint32_t)0x20000000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGHR_MODE15_OUTPUT_50M            ((uint32_t)0x30000000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGHR_CNF8_INPUT_ANALOG            ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGHR_CNF8_INPUT_FLOAT             ((uint32_t)0x00000004) /* Floating Input */
#define GPIO_CFGHR_CNF8_INPUT_PULL              ((uint32_t)0x00000008) /* Input With Pull-Up/Down */
#define GPIO_CFGHR_CNF8_OUTPUT_PUSH_PULL        ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGHR_CNF8_OUTPUT_MUX_PUSH_PULL    ((uint32_t)0x00000008) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGHR_CNF9_INPUT_ANALOG            ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGHR_CNF9_INPUT_FLOAT             ((uint32_t)0x00000040) /* Floating Input */
#define GPIO_CFGHR_CNF9_INPUT_PULL              ((uint32_t)0x00000080) /* Input With Pull-Up/Down */
#define GPIO_CFGHR_CNF9_OUTPUT_PUSH_PULL        ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGHR_CNF9_OUTPUT_MUX_PUSH_PULL    ((uint32_t)0x00000080) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGHR_CNF10_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGHR_CNF10_INPUT_FLOAT            ((uint32_t)0x00000400) /* Floating Input */
#define GPIO_CFGHR_CNF10_INPUT_PULL             ((uint32_t)0x00000800) /* Input With Pull-Up/Down */
#define GPIO_CFGHR_CNF10_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGHR_CNF10_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x00000800) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGHR_CNF11_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGHR_CNF11_INPUT_FLOAT            ((uint32_t)0x00004000) /* Floating Input */
#define GPIO_CFGHR_CNF11_INPUT_PULL             ((uint32_t)0x00008000) /* Input With Pull-Up/Down */
#define GPIO_CFGHR_CNF11_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGHR_CNF11_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x00008000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGHR_CNF12_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGHR_CNF12_INPUT_FLOAT            ((uint32_t)0x00040000) /* Floating Input */
#define GPIO_CFGHR_CNF12_INPUT_PULL             ((uint32_t)0x00080000) /* Input With Pull-Up/Down */
#define GPIO_CFGHR_CNF12_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGHR_CNF12_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x00080000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGHR_CNF13_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGHR_CNF13_INPUT_FLOAT            ((uint32_t)0x00400000) /* Floating Input */
#define GPIO_CFGHR_CNF13_INPUT_PULL             ((uint32_t)0x00800000) /* Input With Pull-Up/Down */
#define GPIO_CFGHR_CNF13_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGHR_CNF13_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x00800000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGHR_CNF14_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGHR_CNF14_INPUT_FLOAT            ((uint32_t)0x04000000) /* Floating Input */
#define GPIO_CFGHR_CNF14_INPUT_PULL             ((uint32_t)0x08000000) /* Input With Pull-Up/Down */
#define GPIO_CFGHR_CNF14_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGHR_CNF14_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x08000000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGHR_CNF15_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGHR_CNF15_INPUT_FLOAT            ((uint32_t)0x40000000) /* Floating Input */
#define GPIO_CFGHR_CNF15_INPUT_PULL             ((uint32_t)0x80000000) /* Input With Pull-Up/Down */
#define GPIO_CFGHR_CNF15_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGHR_CNF15_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x80000000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGXR_MODE16_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGXR_MODE16_OUTPUT_10M            ((uint32_t)0x00000001) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGXR_MODE16_OUTPUT_2M             ((uint32_t)0x00000002) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGXR_MODE16_OUTPUT_50M            ((uint32_t)0x00000003) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGXR_MODE17_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGXR_MODE17_OUTPUT_10M            ((uint32_t)0x00000010) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGXR_MODE17_OUTPUT_2M             ((uint32_t)0x00000020) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGXR_MODE17_OUTPUT_50M            ((uint32_t)0x00000030) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGXR_MODE18_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGXR_MODE18_OUTPUT_10M            ((uint32_t)0x00000100) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGXR_MODE18_OUTPUT_2M             ((uint32_t)0x00000200) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGXR_MODE18_OUTPUT_50M            ((uint32_t)0x00000300) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGXR_MODE19_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGXR_MODE19_OUTPUT_10M            ((uint32_t)0x00001000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGXR_MODE19_OUTPUT_2M             ((uint32_t)0x00002000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGXR_MODE19_OUTPUT_50M            ((uint32_t)0x00003000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGXR_MODE20_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGXR_MODE20_OUTPUT_10M            ((uint32_t)0x00010000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGXR_MODE20_OUTPUT_2M             ((uint32_t)0x00020000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGXR_MODE20_OUTPUT_50M            ((uint32_t)0x00030000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGXR_MODE21_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGXR_MODE21_OUTPUT_10M            ((uint32_t)0x00100000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGXR_MODE21_OUTPUT_2M             ((uint32_t)0x00200000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGXR_MODE21_OUTPUT_50M            ((uint32_t)0x00300000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGXR_MODE22_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGXR_MODE22_OUTPUT_10M            ((uint32_t)0x01000000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGXR_MODE22_OUTPUT_2M             ((uint32_t)0x02000000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGXR_MODE22_OUTPUT_50M            ((uint32_t)0x03000000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGXR_MODE23_INPUT                 ((uint32_t)0x00000000) /* Input Mode */
#define GPIO_CFGXR_MODE23_OUTPUT_10M            ((uint32_t)0x10000000) /* Output Mode, max. speed 10MHz */
#define GPIO_CFGXR_MODE23_OUTPUT_2M             ((uint32_t)0x20000000) /* Output Mode, max. speed 2MHz */
#define GPIO_CFGXR_MODE23_OUTPUT_50M            ((uint32_t)0x30000000) /* Output Mode, max. speed 50MHz */
...
#define GPIO_CFGXR_CNF16_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGXR_CNF16_INPUT_FLOAT            ((uint32_t)0x00000004) /* Floating Input */
#define GPIO_CFGXR_CNF16_INPUT_PULL             ((uint32_t)0x00000008) /* Input With Pull-Up/Down */
#define GPIO_CFGXR_CNF16_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGXR_CNF16_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x00000008) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGXR_CNF17_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGXR_CNF17_INPUT_FLOAT            ((uint32_t)0x00000040) /* Floating Input */
#define GPIO_CFGXR_CNF17_INPUT_PULL             ((uint32_t)0x00000080) /* Input With Pull-Up/Down */
#define GPIO_CFGXR_CNF17_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGXR_CNF17_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x00000080) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGXR_CNF18_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGXR_CNF18_INPUT_FLOAT            ((uint32_t)0x00000400) /* Floating Input */
#define GPIO_CFGXR_CNF18_INPUT_PULL             ((uint32_t)0x00000800) /* Input With Pull-Up/Down */
#define GPIO_CFGXR_CNF18_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGXR_CNF18_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x00000800) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGXR_CNF19_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGXR_CNF19_INPUT_FLOAT            ((uint32_t)0x00004000) /* Floating Input */
#define GPIO_CFGXR_CNF19_INPUT_PULL             ((uint32_t)0x00008000) /* Input With Pull-Up/Down */
#define GPIO_CFGXR_CNF19_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGXR_CNF19_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x00008000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGXR_CNF20_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGXR_CNF20_INPUT_FLOAT            ((uint32_t)0x00040000) /* Floating Input */
#define GPIO_CFGXR_CNF20_INPUT_PULL             ((uint32_t)0x00080000) /* Input With Pull-Up/Down */
#define GPIO_CFGXR_CNF20_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGXR_CNF20_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x00080000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGXR_CNF21_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGXR_CNF21_INPUT_FLOAT            ((uint32_t)0x00400000) /* Floating Input */
#define GPIO_CFGXR_CNF21_INPUT_PULL             ((uint32_t)0x00800000) /* Input With Pull-Up/Down */
#define GPIO_CFGXR_CNF21_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGXR_CNF21_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x00800000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGXR_CNF22_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGXR_CNF22_INPUT_FLOAT            ((uint32_t)0x04000000) /* Floating Input */
#define GPIO_CFGXR_CNF22_INPUT_PULL             ((uint32_t)0x08000000) /* Input With Pull-Up/Down */
#define GPIO_CFGXR_CNF22_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGXR_CNF22_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x08000000) /* Multiplexed Function Push-Pull Output */
...
#define GPIO_CFGXR_CNF23_INPUT_ANALOG           ((uint32_t)0x00000000) /* Analog Input */
#define GPIO_CFGXR_CNF23_INPUT_FLOAT            ((uint32_t)0x40000000) /* Floating Input */
#define GPIO_CFGXR_CNF23_INPUT_PULL             ((uint32_t)0x80000000) /* Input With Pull-Up/Down */
#define GPIO_CFGXR_CNF23_OUTPUT_PUSH_PULL       ((uint32_t)0x00000000) /* Push-Pull Output */
#define GPIO_CFGXR_CNF23_OUTPUT_MUX_PUSH_PULL   ((uint32_t)0x80000000) /* Multiplexed Function Push-Pull Output */
...
#define AFIO_PCFR1_SPI1_REMAP_NOREMAP           ((uint32_t)0x00000000) /* No remap (NSS/PA4, CK/PA5, MISO/PA6, MOSI/PA7) */
#define AFIO_PCFR1_SPI1_REMAP_MAPPING1          ((uint32_t)0x00000001) /* Mapping (NSS/PB21, CK/PB15, MISO/PA8, MOSI/PA9) */
#define AFIO_PCFR1_SPI1_REMAP_MAPPING2          ((uint32_t)0x00000002) /* Mapping (NSS/PA12, CK/PA11, MISO/PA9, MOSI/PA10) */
#define AFIO_PCFR1_SPI1_REMAP_MAPPING3          ((uint32_t)0x00000003) /* Mapping (NSS/PC4, CK/PC5, MISO/PC6, MOSI/PC7) */
...
#define AFIO_PCFR1_I2C1_REMAP_NOREMAP           ((uint32_t)0x00000000) /* No remap (SCL/PA10, SDA/PA11) */
#define AFIO_PCFR1_I2C1_REMAP_MAPPING1          ((uint32_t)0x00000004) /* Mapping (SCL/PA13, SDA/PA14) */
#define AFIO_PCFR1_I2C1_REMAP_MAPPING2          ((uint32_t)0x00000008) /* Mapping (SCL/PC16, SDA/PC17) */
#define AFIO_PCFR1_I2C1_REMAP_MAPPING3          ((uint32_t)0x0000000C) /* Mapping (SCL/PC19, SDA/PC18) */
#define AFIO_PCFR1_I2C1_REMAP_MAPPING4          ((uint32_t)0x00000010) /* Mapping (SCL/PC17, SDA/PC16) */
#define AFIO_PCFR1_I2C1_REMAP_MAPPING5          ((uint32_t)0x00000014) /* Mapping (SCL/PC18, SDA/PC19) */
...
#define AFIO_PCFR1_USART1_REMAP_NOREMAP         ((uint32_t)0x00000000) /* No remap (RX/PB11, CTS/PC16, TX/PB10, CK/PB9, RTS/PC17) */
#define AFIO_PCFR1_USART1_REMAP_MAPPING1        ((uint32_t)0x00000020) /* Mapping (RX/PA11, CTS/PC16, TX/PA10, CK/PB9, RTS/PC17) */
#define AFIO_PCFR1_USART1_REMAP_MAPPING2        ((uint32_t)0x00000040) /* Mapping (RX/PB11, CTS/PA9, TX/PB10, CK/PB5, RTS/PA8) */
#define AFIO_PCFR1_USART1_REMAP_MAPPING3        ((uint32_t)0x00000060) /* Mapping (RX/PB2, CTS/PA13, TX/PA7, CK/PB12, RTS/PA14) */
...
#define AFIO_PCFR1_USART2_REMAP_NOREMAP         ((uint32_t)0x00000000) /* No remap (RX/PA3, CTS/PA0, TX/PA2, CK/PA4, RTS/PA1) */
#define AFIO_PCFR1_USART2_REMAP_MAPPING1        ((uint32_t)0x00000080) /* Mapping (RX/PA19, CTS/PA1, TX/PA20, CK/PA23, RTS/PA2) */
#define AFIO_PCFR1_USART2_REMAP_MAPPING2        ((uint32_t)0x00000100) /* Mapping (RX/PA16, CTS/PA17, TX/PA15, CK/PA22, RTS/PA21 */
#define AFIO_PCFR1_USART2_REMAP_MAPPING3        ((uint32_t)0x00000180) /* Mapping (RX/PC1, CTS/PC2, TX/PC0, CK/PB20, RTS/PC3) */
#define AFIO_PCFR1_USART2_REMAP_MAPPING4        ((uint32_t)0x00000200) /* Mapping (RX/PA16, CTS/PA17, TX/PA15, CK/PA22, RTS/PC3) */
...
#define AFIO_PCFR1_USART3_REMAP_NOREMAP         ((uint32_t)0x00000000) /* No remap (RX/PB4, CTS/PB6, TX/PB3, CK/PB5, RTS/PB7) */
#define AFIO_PCFR1_USART3_REMAP_MAPPING1        ((uint32_t)0x00000400) /* Mapping (RX/PC19, CTS/PB6, TX/PC18, CK/PB5, RTS/PB7) */
#define AFIO_PCFR1_USART3_REMAP_MAPPING2        ((uint32_t)0x00000800) /* Mapping (RX/PB14，CTS/PA3，TX/PA18，CK/PB8，RTS/PA4) */
#define AFIO_PCFR1_USART3_REMAP_MAPPING3        ((uint32_t)0x00000C00) /* Mapping (RX/PB17, CTS/PB18, TX/PB16, CK unavailable, RTS/PB19) */
...
#define AFIO_PCFR1_USART4_REMAP_NOREMAP         ((uint32_t)0x00000000) /* No remap (RX/PB1, CTS/PB15, TX/PB0, CK/PB2, RTS/PA8) */
#define AFIO_PCFR1_USART4_REMAP_MAPPING1        ((uint32_t)0x00001000) /* Mapping (RX/PA9, CTS/PA7, TX/PA5, CK/PA6, RTS/PB21) */
#define AFIO_PCFR1_USART4_REMAP_MAPPING2        ((uint32_t)0x00002000) /* Mapping (RX/PC17, CTS/PB15, TX/PC16, CK/PB2, RTS/PA8) */
#define AFIO_PCFR1_USART4_REMAP_MAPPING3        ((uint32_t)0x00003000) /* Mapping (RX/PA10, CTS/PA14, TX/PB9, CK/PB8, RTS/PA13) */
#define AFIO_PCFR1_USART4_REMAP_MAPPING4        ((uint32_t)0x00004000) /* Mapping (RX/PC19, CTS/PA5, TX/PB13, CK/PA8, RTS/PA6) */
#define AFIO_PCFR1_USART4_REMAP_MAPPING5        ((uint32_t)0x00005000) /* Mapping (RX/PC16, CTS/PB15, TX/PC17, CK/PB2, RTS/PA8) */
...
#define AFIO_PCFR1_TIM1_REMAP_NOREMAP           ((uint32_t)0x00000000) /* No remap (CH1/PB9, CH2/PB10, CH3/PB11, CH4/PC16, ETR/PC17, BKIN/PB5, C1N/PB6, C2N/PB7, C3N/PB8) */
#define AFIO_PCFR1_TIM1_REMAP_MAPPING1          ((uint32_t)0x00008000) /* Mapping (CH1/PB9, CH2/PB10, CH3/PB11, CH4/PC16, ETR/PC17, BKIN/PA6, C1N/PA7, C2N/PB0, C3N/PB1) */
#define AFIO_PCFR1_TIM1_REMAP_MAPPING2          ((uint32_t)0x00010000) /* Mapping (CH1/PB9, CH2/PB10, CH3/PB11, CH4/PB12, ETR/PC18, BKIN/PB5, C1N/PB6, C2N/PB7, C3N/PB8) */
#define AFIO_PCFR1_TIM1_REMAP_MAPPING3          ((uint32_t)0x00018000) /* Mapping (CH1/PC0, CH2/PC1, CH3/PC2, CH4/PC3, ETR/PC18, BKIN/PC4, C1N/PC5, C2N/PC6, C3N/PC7) */
#define AFIO_PCFR1_TIM1_REMAP_MAPPING4          ((uint32_t)0x00020000) /* Mapping (CH1/CH2/CH4/BKIN/C1N/C2N/C3N cannot use, CH3/PC14, ETR/PC15) */
...
#define AFIO_PCFR1_TIM2_REMAP_NOREMAP           ((uint32_t)0x00000000) /* No remap (CH1/PA0, CH2/PA1, CH3/PA2, CH4/PA3, ETR/PA19, BKIN/PA20, C1N/PA21, C2N/PA22, C3N/PA23) */
#define AFIO_PCFR1_TIM2_REMAP_MAPPING1          ((uint32_t)0x00040000) /* Mapping (CH1/PB21, CH2/PB15, CH3/PA2, CH4/PA3, ETR/PA18, BKIN/PA9, C1N/PA12, C2N/PA13, C3N/PA14) */
#define AFIO_PCFR1_TIM2_REMAP_MAPPING2          ((uint32_t)0x00080000) /* Mapping (CH1/PA0, CH2/PA1, CH3/PB3, CH4/PB4, ETR/PA19, BKIN/PA20, C1N/PC3, C2N/PA22, C3N/PA23) */
#define AFIO_PCFR1_TIM2_REMAP_MAPPING3          ((uint32_t)0x000C0000) /* Mapping (CH1/PB21, CH2/PB15, CH3/PB3, CH4/PB4, ETR/PA18, BKIN/PA9, C1N/PA12, C2N/PA13, C3N/PA14) */
#define AFIO_PCFR1_TIM2_REMAP_MAPPING4          ((uint32_t)0x00100000) /* Mapping (CH1/PB16, CH2/PB17, CH3/PB18, CH4/PB19, ETR/PC4, BKIN/PC0, C1N/PC1, C2N/PC2, C3N/PC3) */
#define AFIO_PCFR1_TIM2_REMAP_MAPPING5          ((uint32_t)0x00140000) /* Mapping (CH1/PC19, CH2/PA12, CH3/PA13, CH4/PC0, ETR/PA2, BKIN/PB4, C1N/PC18, C2N/PB12, C3N/PB3) */
#define AFIO_PCFR1_TIM2_REMAP_MAPPING6          ((uint32_t)0x00180000) /* Mapping (CH1/PC19, CH2/PC14, CH3/PC15, CH4/PC0, ETR/PA2, BKIN/PB4, C1N/PB11, C2N/PB12, C3N/PB3) */
...
#define AFIO_PCFR1_TIM3_REMAP_NOREMAP           ((uint32_t)0x00000000) /* No remap (CH1/PA6, CH2/PA7) */
#define AFIO_PCFR1_TIM3_REMAP_MAPPING1          ((uint32_t)0x00200000) /* Mapping (CH1/PB4, CH2/PB5) */
#define AFIO_PCFR1_TIM3_REMAP_MAPPING2          ((uint32_t)0x00400000) /* Mapping (CH1/PC19, CH2/PC18) */
#define AFIO_PCFR1_TIM3_REMAP_MAPPING3          ((uint32_t)0x00600000) /* Mapping (CH1/PA3, CH2/PA4) */

#define AFIO_PCFR1_PIOC_REMAP                   ((uint32_t)0x00800000) /* PIOC[23] bits (PIOC remapping) */
#define AFIO_PCFR1_PIOC_REMAP_NOREMAP           ((uint32_t)0x00000000) /* No remap ([0]/PC18, [1]/PC19) */
#define AFIO_PCFR1_PIOC_REMAP_MAPPING           ((uint32_t)0x00800000) /* Mapping ([0]/PC7, [1]/PC19) */
...
#define AFIO_PCFR1_SWJ_CFG_ENABLED              ((uint32_t)0x00000000) /* SWD enabled */
#define AFIO_PCFR1_SWJ_CFG_DISABLED             ((uint32_t)0x04000000) /* SWD disabled, functions as GPIO */
...
#define AFIO_CTLR_UDM_PUE_DISABLE               ((uint32_t)0x00000000)
#define AFIO_CTLR_UDM_PUE_35UA                  ((uint32_t)0x00000001)
...
#define AFIO_CTLR_UDP_PUE_DISABLE               ((uint32_t)0x00000000)
#define AFIO_CTLR_UDP_PUE_35UA                  ((uint32_t)0x00000004)
...
#define AFIO_CTLR_USB_PHY_V33_DIRECT            ((uint32_t)0x00000040)
#define AFIO_CTLR_USB_PHY_V33_LDO               ((uint32_t)0x00000000)
...
#define AFIO_CTLR_USBPD_PHY_V33_DIRECT          ((uint32_t)0x00000100)
#define AFIO_CTLR_USBPD_PHY_V33_LDO             ((uint32_t)0x00000000)
...
#define IWDG_PR_DIV_4                           ((uint8_t)0x00) /* Divided by 4 */
#define IWDG_PR_DIV_8                           ((uint8_t)0x01) /* Divided by 8 */
#define IWDG_PR_DIV_16                          ((uint8_t)0x02) /* Divided by 16 */
#define IWDG_PR_DIV_32                          ((uint8_t)0x03) /* Divided by 32 */
#define IWDG_PR_DIV_64                          ((uint8_t)0x04) /* Divided by 64 */
#define IWDG_PR_DIV_128                         ((uint8_t)0x05) /* Divided by 128 */
#define IWDG_PR_DIV_256                         ((uint8_t)0x06) /* Divided by 256 */
...
#define PWR_CTLR_PLS_2V12R_2V10F                ((uint16_t)0x0000) /* 2.12V rising edge/2.10V falling edge */
#define PWR_CTLR_PLS_2V32R_2V30F                ((uint16_t)0x0020) /* 2.32V rising edge/2.30V falling edge */
#define PWR_CTLR_PLS_3V02R_3V00F                ((uint16_t)0x0040) /* 3.02V rising edge/3.00V falling edge */
#define PWR_CTLR_PLS_4V02R_4V00F                ((uint16_t)0x0060) /* 4.02V rising edge/4.00V falling edge */
...
#define PWR_CTLR_LP_0                           ((uint16_t)0x0400) /* Bit 0 */
#define PWR_CTLR_LP_1                           ((uint16_t)0x0800) /* Bit 1 */

#define PWR_CTLR_LP_IDLE                        ((uint16_t)0x0000) /* Idle */
#define PWR_CTLR_LP_SLEEP                       ((uint16_t)0x0400) /* Sleep */
...
#define RCC_MCO                                 ((uint32_t)0x07000000) /* MCO[2:0] bits (Microcontroller Clock Output) */
...
#define RCC_MCO_SYSCLK                          ((uint32_t)0x04000000) /* System clock selected as MCO source */
#define RCC_MCO_HSI                             ((uint32_t)0x05000000) /* HSI clock selected as MCO source */
...
#define USART_CTLR1_TXEIE                       ((uint16_t)0x0080) /* TXE Interrupt Enable */
...
#define USART_CTLR2_STOP_BITS_1                 ((uint16_t)0x0000) /* 1 STOP bit */
#define USART_CTLR2_STOP_BITS_0_5               ((uint16_t)0x1000) /* 0.5 STOP bits */
#define USART_CTLR2_STOP_BITS_2                 ((uint16_t)0x2000) /* 2 STOP bits */
#define USART_CTLR2_STOP_BITS_1_5               ((uint16_t)0x3000) /* 1.5 STOP bits */
...
/*******************  Bit definition for BASE_CTRL register  ********************/
#define USBFS_BASE_CTRL_UC_HOST_MODE            ((uint8_t)0x80)
#define USBFS_BASE_CTRL_UC_HOST_MODE_DEVICE     ((uint8_t)0x00)
#define USBFS_BASE_CTRL_UC_HOST_MODE_HOST       ((uint8_t)0x80)

#define USBFS_BASE_CTRL_UC_LOW_SPEED            ((uint8_t)0x40)
#define USBFS_BASE_CTRL_UC_DEV_PU_EN            ((uint8_t)0x20)

#define USBFS_BASE_CTRL_UC_SYS_CTRL_MASK        ((uint8_t)0x30)
#define USBFS_BASE_CTRL_UC_SYS_CTRL0            ((uint8_t)0x00)
#define USBFS_BASE_CTRL_UC_SYS_CTRL1            ((uint8_t)0x10)
#define USBFS_BASE_CTRL_UC_SYS_CTRL2            ((uint8_t)0x20)
#define USBFS_BASE_CTRL_UC_SYS_CTRL3            ((uint8_t)0x30)

#define USBFS_BASE_CTRL_UC_INT_BUSY             ((uint8_t)0x08)
#define USBFS_BASE_CTRL_UC_RST_SIE              ((uint8_t)0x04)
#define USBFS_BASE_CTRL_UC_CLR_ALL              ((uint8_t)0x02)
#define USBFS_BASE_CTRL_UC_DMA_EN               ((uint8_t)0x01)

/*******************  Bit definition for INT_EN register  ********************/
#define USBFS_INT_EN_UIE_DEV_SOF                ((uint8_t)0x80)
#define USBFS_INT_EN_UIE_DEV_NAK                ((uint8_t)0x40)
#define USBFS_INT_EN_UID_1_WIRE                 ((uint8_t)0x20)
#define USBFS_INT_EN_UIE_FIFO_OV                ((uint8_t)0x10)
#define USBFS_INT_EN_UIE_SOF_ACT                ((uint8_t)0x08)
#define USBFS_INT_EN_UIE_SUSPEND                ((uint8_t)0x04)
#define USBFS_INT_EN_UIE_TRANSFER               ((uint8_t)0x02)
#define USBFS_INT_EN_UIE_DETECT                 ((uint8_t)0x01)
#define USBFS_INT_EN_UIE_BUS_RST                ((uint8_t)0x01)

/*******************  Bit definition for DEV_ADDR register  ********************/
#define USBFS_DEV_ADDR_UDA_GP_BIT               ((uint8_t)0x80)
#define USBFS_DEV_ADDR_MASK_USB_ADDR            ((uint8_t)0x7F)

/*******************  Bit definition for MIS_ST register  ********************/
#define USBFS_MIS_ST_UMS_SOF_PRES               ((uint8_t)0x80)
#define USBFS_MIS_ST_UMS_SOF_ACT                ((uint8_t)0x40)
#define USBFS_MIS_ST_UMS_SIE_FREE               ((uint8_t)0x20)
#define USBFS_MIS_ST_UMS_R_FIFO_RDY             ((uint8_t)0x10)
#define USBFS_MIS_ST_UMS_BUS_RST                ((uint8_t)0x08)
#define USBFS_MIS_ST_UMS_SUSPEND                ((uint8_t)0x04)
#define USBFS_MIS_ST_UMS_DM_LEVEL               ((uint8_t)0x02)
#define USBFS_MIS_ST_UMS_DEV_ATTACH             ((uint8_t)0x01)

/*******************  Bit definition for INT_FG register  ********************/
#define USBFS_INT_FG_U_IS_NAK                   ((uint8_t)0x80) // RO, indicate current USB transfer is NAK received for USB device mode
#define USBFS_INT_FG_U_TOG_OK                   ((uint8_t)0x40) // RO, indicate current USB transfer toggle is OK
#define USBFS_INT_FG_U_SIE_FREE                 ((uint8_t)0x20) // RO, indicate USB SIE free status
#define USBFS_INT_FG_UIF_FIFO_OV                ((uint8_t)0x10) // FIFO overflow interrupt flag for USB, direct bit address clear or write 1 to clear
#define USBFS_INT_FG_UIF_HST_SOF                ((uint8_t)0x08) // host SOF timer interrupt flag for USB host, direct bit address clear or write 1 to clear
#define USBFS_INT_FG_UIF_SUSPEND                ((uint8_t)0x04) // USB suspend or resume event interrupt flag, direct bit address clear or write 1 to clear
#define USBFS_INT_FG_UIF_TRANSFER               ((uint8_t)0x02) // USB transfer completion interrupt flag, direct bit address clear or write 1 to clear
#define USBFS_INT_FG_UIF_DETECT                 ((uint8_t)0x01) // device detected event interrupt flag for USB host mode, direct bit address clear or write 1 to clear
#define USBFS_INT_FG_UIF_BUS_RST                ((uint8_t)0x01) // bus reset event interrupt flag for USB device mode, direct bit address clear or write 1 to clear

/*******************  Bit definition for INT_ST register  ********************/
#define USBFS_INT_ST_SETUP_ACT                  ((uint8_t)0x80) // RO, indicate current USB transfer SETUP is complete
#define USBFS_INT_ST_UIS_TOG_OK                 ((uint8_t)0x40) // RO, indicate current USB transfer toggle is OK

#define USBFS_INT_ST_UIS_TOKEN_MASK             ((uint8_t)0x30) // RO, bit mask of current token PID code received for USB device mode
#define USBFS_INT_ST_UIS_TOKEN_OUT              ((uint8_t)0x00) // 00: OUT token PID received
#define USBFS_INT_ST_UIS_TOKEN_SOF              ((uint8_t)0x10) // 01: SOF token PID received
#define USBFS_INT_ST_UIS_TOKEN_IN               ((uint8_t)0x20) // 10: IN token PID received
#define USBFS_INT_ST_UIS_TOKEN_SETUP            ((uint8_t)0x30) // 11: SETUP token PID received

#define USBFS_INT_ST_UIS_ENDP_MASK              ((uint8_t)0x0F) // RO, bit mask of current transfer endpoint number for USB device mode
#define USBFS_INT_ST_UIS_H_RES_MASK             ((uint8_t)0x0F) // RO, bit mask of current transfer handshake response for USB host mode: 0000=no response, time out from device, others=handshake response PID received

/*******************  Bit definition for UDEV_CTRL register  ********************/
#define USBFS_UDEV_CTRL_UD_PD_DIS               ((uint8_t)0x80) // disable USB UDP/UDM pulldown resistance: 0=enable pulldown, 1=disable
#define USBFS_UDEV_CTRL_UD_DP_PIN               ((uint8_t)0x20) // ReadOnly: indicate current UDP pin level
#define USBFS_UDEV_CTRL_UD_DM_PIN               ((uint8_t)0x10) // ReadOnly: indicate current UDM pin level
#define USBFS_UDEV_CTRL_UD_LOW_SPEED            ((uint8_t)0x04) // enable USB physical port low speed: 0=full speed, 1=low speed
#define USBFS_UDEV_CTRL_UD_GP_BIT               ((uint8_t)0x02) // general purpose bit
#define USBFS_UDEV_CTRL_UD_PORT_EN              ((uint8_t)0x01) // enable USB physical port I/O: 0=disable, 1=enable

/*******************  Bit definition for UEP4_1_MOD register  ********************/
#define USBFS_UEP4_1_MOD_EP1_R_EN               ((uint8_t)0x80) // enable USB endpoint 1 receiving (OUT)
#define USBFS_UEP4_1_MOD_EP1_T_EN               ((uint8_t)0x40) // enable USB endpoint 1 transmittal (IN)
#define USBFS_UEP4_1_MOD_EP1_BUF_MOD            ((uint8_t)0x10) // buffer mode of USB endpoint 1
#define USBFS_UEP4_1_MOD_EP4_R_EN               ((uint8_t)0x08) // enable USB endpoint 4 receiving (OUT)
#define USBFS_UEP4_1_MOD_EP4_T_EN               ((uint8_t)0x04) // enable USB endpoint 4 transmittal (IN)

/*******************  Bit definition for UEP2_3_MOD register  ********************/
#define USBFS_UEP2_3_MOD_EP3_R_EN               ((uint8_t)0x80) // enable USB endpoint 3 receiving (OUT)
#define USBFS_UEP2_3_MOD_EP3_T_EN               ((uint8_t)0x40) // enable USB endpoint 3 transmittal (IN)
#define USBFS_UEP2_3_MOD_EP3_BUF_MOD            ((uint8_t)0x10) // buffer mode of USB endpoint 3
#define USBFS_UEP2_3_MOD_EP2_R_EN               ((uint8_t)0x08) // enable USB endpoint 2 receiving (OUT)
#define USBFS_UEP2_3_MOD_EP2_T_EN               ((uint8_t)0x04) // enable USB endpoint 2 transmittal (IN)
#define USBFS_UEP2_3_MOD_EP2_BUF_MOD            ((uint8_t)0x01) // buffer mode of USB endpoint 2

/*******************  Bit definition for UEP567_MOD register  ********************/
#define USBFS_UEP567_MOD_EP5_R_EN               ((uint8_t)0x02) // enable USB endpoint 5 receiving (OUT)
#define USBFS_UEP567_MOD_EP5_T_EN               ((uint8_t)0x01) // enable USB endpoint 5 transmittal (IN)
#define USBFS_UEP567_MOD_EP6_R_EN               ((uint8_t)0x08) // enable USB endpoint 6 receiving (OUT)
#define USBFS_UEP567_MOD_EP6_T_EN               ((uint8_t)0x04) // enable USB endpoint 6 transmittal (IN)
#define USBFS_UEP567_MOD_EP7_R_EN               ((uint8_t)0x20) // enable USB endpoint 7 receiving (OUT)
#define USBFS_UEP567_MOD_EP7_T_EN               ((uint8_t)0x10) // enable USB endpoint 7 transmittal (IN)

/*******************  Bit definition for UEPn_CTRL_H register  ********************/
#define USBFS_UEPn_CTRL_H_R_TOG                 ((uint16_t)0x80) // expected data toggle flag of USB endpoint X receiving (OUT): 0=DATA0, 1=DATA1
#define USBFS_UEPn_CTRL_H_T_TOG                 ((uint16_t)0x40) // prepared data toggle flag of USB endpoint X transmittal (IN): 0=DATA0, 1=DATA1
#define USBFS_UEPn_CTRL_H_TOG_AUTO              ((uint16_t)0x10) // enable automatic toggle after successful transfer completion on endpoint 1/2/3: 0=manual toggle, 1=automatic toggle

#define USBFS_UEPn_CTRL_H_R_RES_MASK            ((uint16_t)0x0C) // bit mask of handshake response type for USB endpoint X receiving (OUT)
#define USBFS_UEPn_CTRL_H_R_RES_ACK             ((uint16_t)0x00) // 00: ACK (ready)
#define USBFS_UEPn_CTRL_H_R_RES_NONE            ((uint16_t)0x04) // 01: no response, time out to host, for non-zero endpoint isochronous transactions
#define USBFS_UEPn_CTRL_H_R_RES_NAK             ((uint16_t)0x08) // 10: NAK (busy)
#define USBFS_UEPn_CTRL_H_R_RES_STALL           ((uint16_t)0x0C) // 11: STALL (error)

#define USBFS_UEPn_CTRL_H_T_RES_MASK            ((uint16_t)0x03) // bit mask of handshake response type for USB endpoint X transmittal (IN)
#define USBFS_UEPn_CTRL_H_T_RES_ACK             ((uint16_t)0x00) // 00: DATA0 or DATA1 then expecting ACK (ready)
#define USBFS_UEPn_CTRL_H_T_RES_NONE            ((uint16_t)0x01) // 01: DATA0 or DATA1 then expecting no response, time out from host, for non-zero endpoint isochronous transactions
#define USBFS_UEPn_CTRL_H_T_RES_NAK             ((uint16_t)0x02) // 10: NAK (busy)
#define USBFS_UEPn_CTRL_H_T_RES_STALL           ((uint16_t)0x03) // 11: STALL (error)

/*******************  Bit definition for UEPX_MOD register  ********************/
#define USBFS_UEPX_MOD_EP_T_AF_MASK             ((uint32_t)0x00FE0000) // Transmit endpoint alternate enable
// TODO: bits 17-23 map to alternate endpoints 9-15?

#define USBFS_UEPX_MOD_EP_R_EN_MASK             ((uint32_t)0x0000FF00)
#define USBFS_UEPX_MOD_EP8_R_EN                 ((uint32_t)0x00000100) // enable USB endpoint 8 receiving (OUT)
#define USBFS_UEPX_MOD_EP9_R_EN                 ((uint32_t)0x00000200) // enable USB endpoint 9 receiving (OUT)
#define USBFS_UEPX_MOD_EP10_R_EN                ((uint32_t)0x00000400) // enable USB endpoint 10 receiving (OUT)
#define USBFS_UEPX_MOD_EP11_R_EN                ((uint32_t)0x00000800) // enable USB endpoint 11 receiving (OUT)
#define USBFS_UEPX_MOD_EP12_R_EN                ((uint32_t)0x00001000) // enable USB endpoint 12 receiving (OUT)
#define USBFS_UEPX_MOD_EP13_R_EN                ((uint32_t)0x00002000) // enable USB endpoint 13 receiving (OUT)
#define USBFS_UEPX_MOD_EP14_R_EN                ((uint32_t)0x00004000) // enable USB endpoint 14 receiving (OUT)
#define USBFS_UEPX_MOD_EP15_R_EN                ((uint32_t)0x00008000) // enable USB endpoint 15 receiving (OUT)

#define USBFS_UEPX_MOD_EP_T_EN_MASK             ((uint32_t)0x000000FF)
#define USBFS_UEPX_MOD_EP8_T_EN                 ((uint32_t)0x00000001) // enable USB endpoint 8 transmittal (IN)
#define USBFS_UEPX_MOD_EP9_T_EN                 ((uint32_t)0x00000002) // enable USB endpoint 9 transmittal (IN)
#define USBFS_UEPX_MOD_EP10_T_EN                ((uint32_t)0x00000004) // enable USB endpoint 10 transmittal (IN)
#define USBFS_UEPX_MOD_EP11_T_EN                ((uint32_t)0x00000008) // enable USB endpoint 11 transmittal (IN)
#define USBFS_UEPX_MOD_EP12_T_EN                ((uint32_t)0x00000010) // enable USB endpoint 12 transmittal (IN)
#define USBFS_UEPX_MOD_EP13_T_EN                ((uint32_t)0x00000020) // enable USB endpoint 13 transmittal (IN)
#define USBFS_UEPX_MOD_EP14_T_EN                ((uint32_t)0x00000040) // enable USB endpoint 14 transmittal (IN)
#define USBFS_UEPX_MOD_EP15_T_EN                ((uint32_t)0x00000080) // enable USB endpoint 15 transmittal (IN)

/*******************  Bit definition for HOST_CTRL register  ********************/
#define USBFS_HOST_CTRL_UH_PD_DIS               ((uint8_t)0x80) // disable USB UDP/UDM pulldown resistance: 0=enable pulldown, 1=disable
#define USBFS_HOST_CTRL_UH_DP_PIN               ((uint8_t)0x20) // ReadOnly: indicate current UDP pin level
#define USBFS_HOST_CTRL_UH_DM_PIN               ((uint8_t)0x10) // ReadOnly: indicate current UDM pin level
#define USBFS_HOST_CTRL_UH_LOW_SPEED            ((uint8_t)0x04) // enable USB port low speed: 0=full speed, 1=low speed
#define USBFS_HOST_CTRL_UH_BUS_RESET            ((uint8_t)0x02) // control USB bus reset: 0=normal, 1=force bus reset
#define USBFS_HOST_CTRL_UH_PORT_EN              ((uint8_t)0x01) // enable USB port: 0=disable, 1=enable port, automatic disabled if USB device detached

/*******************  Bit definition for HOST_EP_MOD register  ********************/
#define USBFS_HOST_EP_MOD_UH_EP_TX_EN           ((uint8_t)0x40) // enable USB host OUT endpoint transmittal

#define USBFS_HOST_EP_MOD_UH_EP_TBUF_MOD        ((uint8_t)0x10) // buffer mode of USB host OUT endpoint
#define USBFS_HOST_EP_MOD_UH_EP_TBUF_MOD_SINGLE ((uint8_t)0x00) // single 64-byte transmit buffer (SETUP/OUT)
#define USBFS_HOST_EP_MOD_UH_EP_TBUF_MOD_DOUBLE ((uint8_t)0x10) // double 64-byte transmit buffer

#define USBFS_HOST_EP_MOD_UH_EP_RX_EN           ((uint8_t)0x08) // enable USB host IN endpoint receiving

#define USBFS_HOST_EP_MOD_UH_EP_RBUF_MOD        ((uint8_t)0x01) // buffer mode of USB host IN endpoint
#define USBFS_HOST_EP_MOD_UH_EP_RBUF_MOD_SINGLE ((uint8_t)0x00) // single 64-byte receive buffer (IN)
#define USBFS_HOST_EP_MOD_UH_EP_RBUF_MOD_DOUBLE ((uint8_t)0x01) // double 64-byte receive buffer

/*******************  Bit definition for HOST_SETUP register  ********************/
#define USBFS_HOST_SETUP_UH_PRE_PID_EN          ((uint8_t)0x80) // USB host PRE PID enable for low speed device via hub
#define USBFS_HOST_SETUP_UH_SOF_EN              ((uint8_t)0x40) // USB host automatic SOF enable

/*******************  Bit definition for HOST_EP_PID register  ********************/
#define USBFS_HOST_EP_PID_UH_TOKEN_MASK         ((uint8_t)0xF0) // bit mask of token PID for USB host transfer
#define USBFS_HOST_EP_PID_UH_ENDP_MASK          ((uint8_t)0x0F) // bit mask of endpoint number for USB host transfer

/*******************  Bit definition for HOST_RX_CTRL register  ********************/
#define USBFS_HOST_RX_CTRL_UH_R_TOG             ((uint8_t)0x80) // expected data toggle flag of host receiving (IN): 0=DATA0, 1=DATA1
#define USBFS_HOST_RX_CTRL_UH_R_TOG_DATA1       ((uint8_t)0x80)
#define USBFS_HOST_RX_CTRL_UH_R_TOG_DATA0       ((uint8_t)0x00)

#define USBFS_HOST_RX_CTRL_UH_R_AUTO_TOG        ((uint8_t)0x10) // enable automatic toggle after successful transfer completion: 0=manual toggle, 1=automatic toggle

#define USBFS_HOST_RX_CTRL_UH_R_RES             ((uint8_t)0x02) // prepared handshake response type for host receiving (IN): 0=ACK (ready), 1=no response, time out to device, for isochronous transactions
#define USBFS_HOST_RX_CTRL_UH_R_RES_NONE        ((uint8_t)0x02)
#define USBFS_HOST_RX_CTRL_UH_R_RES_ACK         ((uint8_t)0x00)

/*******************  Bit definition for HOST_TX_CTRL register  ********************/
#define USBFS_HOST_TX_CTRL_UH_T_TOG             ((uint8_t)0x40) // prepared data toggle flag of host transmittal (SETUP/OUT): 0=DATA0, 1=DATA1
#define USBFS_HOST_TX_CTRL_UH_T_TOG_DATA1       ((uint8_t)0x40)
#define USBFS_HOST_TX_CTRL_UH_T_TOG_DATA0       ((uint8_t)0x00)

#define USBFS_HOST_TX_CTRL_UH_T_AUTO_TOG        ((uint8_t)0x10) // enable automatic toggle after successful transfer completion: 0=manual toggle, 1=automatic toggle

#define USBFS_HOST_TX_CTRL_UH_T_RES             ((uint8_t)0x01) // expected handshake response type for host transmittal (SETUP/OUT): 0=ACK (ready), 1=no response, time out from device, for isochronous transactions
#define USBFS_HOST_TX_CTRL_UH_T_RES_NONE        ((uint8_t)0x01)
#define USBFS_HOST_TX_CTRL_UH_T_RES_ACK         ((uint8_t)0x00)

/******************************************************************************/
/*                              VENDOR                                        */
/******************************************************************************/

/*******************  Bit definition for CHIPID register  ********************/
#define VENDOR_CHIPID_CH32X035R8T               ((uint32_t)0x03500600)
#define VENDOR_CHIPID_CH32X035C8T               ((uint32_t)0x03510600)
#define VENDOR_CHIPID_CH32X035F8U               ((uint32_t)0x035E0600)
#define VENDOR_CHIPID_CH32X035G8U               ((uint32_t)0x03560600)
#define VENDOR_CHIPID_CH32X035G8R               ((uint32_t)0x035B0600)
#define VENDOR_CHIPID_CH32X035F7P               ((uint32_t)0x03570600)
#define VENDOR_CHIPID_CH32X033F8P               ((uint32_t)0x035A0600)
